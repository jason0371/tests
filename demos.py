...
def image_demo():
  ...
  with tf.Graph().as_default():
    ...
    with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
      ...
      cam = cv2.VideoCapture('../dataset/test2.mp4') #'/home/siiva/RUDY/SIIVA/GoalCam/annotations/toys2/original_data/test1.MOV')
...
def cam_demo():
  ...
  with tf.Graph().as_default():
    ...
    with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
      ...
      #cam = cv2.VideoCapture('../dataset/test2.mp4')#'/home/siiva/RUDY/SIIVA/GoalCam/annotations/mi5_toysbball/vid5/original_data/vid5.mp4') #'/home/siiva/RUDY/SIIVA/GoalCam/annotations/toys2/original_data/test1.MOV')
      print(cam.read())
